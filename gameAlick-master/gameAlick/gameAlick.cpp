...
void Logic()
{
	...
	{
	case UP: character.ch_x--; current_draw_map[character.ch_x+1][character.ch_y] = ' ';  DrawMap(character.ch_skin, current_map_name, character.ch_move); break;
	case DOWN: character.ch_x++; current_draw_map[character.ch_x-1][character.ch_y] = ' '; DrawMap(character.ch_skin, current_map_name, character.ch_move); break;
	case RIGHT:character.ch_y++; current_draw_map[character.ch_x][character.ch_y-1] = ' '; DrawMap(character.ch_skin, current_map_name, character.ch_move); break;
	case LEFT:character.ch_y--; current_draw_map[character.ch_x][character.ch_y+1] = ' '; DrawMap(character.ch_skin, current_map_name, character.ch_move); break;
